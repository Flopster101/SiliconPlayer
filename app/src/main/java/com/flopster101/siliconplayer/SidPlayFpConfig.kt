...
internal object SidPlayFpOptionKeys {
    const val BACKEND = "sidplayfp.backend"
    const val CLOCK_MODE = "sidplayfp.clock_mode"
    const val SID_MODEL_MODE = "sidplayfp.sid_model_mode"
    const val FORCE_SID_MODEL = "sidplayfp.force_sid_model" // legacy
