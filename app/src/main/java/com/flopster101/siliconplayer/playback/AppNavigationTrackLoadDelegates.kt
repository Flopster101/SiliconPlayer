...
internal class AppNavigationTrackLoadDelegates(
    ...
    private val onCurrentPlaybackRequestUrlChanged: (String?) -> Unit,
    private val onActivePlaylistChanged: (StoredPlaylist?) -> Unit,
    private val onActivePlaylistEntryIdChanged: (String?) -> Unit,
    private val onActivePlaylistShuffleActiveChanged: (Boolean) -> Unit,
    private val onPendingPlaylistSubtuneSelectionChanged: (String?, Int?) -> Unit,
    ...
    private val onResolvedDecoderState: (String?) -> Unit,
        ...
        currentTrackSelectionJob = appScope.launch {
            try {
                applyTrackSelectionAction(
                    ...
                    file = file,
                    autoStart = autoStart,
                    wasPlayingBeforeSelection = isPlayingProvider(),
                    ...
                    onResolvedDecoderState = onResolvedDecoderState,
